...
OSF.OmexIframeNotificationUrlParameterKeys = {
    AppName: "client",
    AppVersion: "cv",
    AppUILocale: "ui",
    AppDomain: "appDomain",
...
(function(OSFAppTelemetry)
{
    ...
    function initialize(context)
    {
        ...
        appInfo.hostJSVersion = "16.0.8529.1000";
...
(function(OfficeExt)
{
    ...
    (function(AddinNativeAction)
    {
        ...
        (function(Dialog)
        {
            ...
            {
                var hostInfoObj = OSF._OfficeAppFactory.getInitializationHelper()._hostInfo;
                var hostInfoVals = [hostInfoObj.hostType,hostInfoObj.hostPlatform,hostInfoObj.hostSpecificFileVersion,hostInfoObj.hostLocale,hostInfoObj.osfControlAppCorrelationId,"isDialog"];
...
OSF.DDA.WAC.Delegate.ParameterMap.define({
    ...
    fromHost: [{
            ...
            value: OSF.DDA.WAC.Delegate.ParameterMap.sourceData
        }],
    isComplexType: true
});
OSF.DDA.WAC.Delegate.ParameterMap.define({
            ...
            var invokeResponseCallback = function(resultCode, resultData)
                {
                    ...
                    {
                        var deserializedData = resultData;
                        var detailedErrorCode = -1;
                        if(deserializedData && deserializedData["errorCode"])
                            detailedErrorCode = deserializedData["errorCode"];
