...
Strings.OfficeOM.L_ConfirmDialogConsent = "按一下 [確定]，即表示您允許 {0} 存取您的內容與個人資訊。 ";
...
Strings.OfficeOM.L_CancelButton = "取消";
...
Strings.OfficeOM.L_ConfirmDialogConsentTitle = "請稍候...";
...
Strings.OfficeOM.L_OKButton = "確定";
...
Strings.OfficeOM.L_ConfirmDialog = "網域 {0} 做為 Microsoft Office，且可執行 Office 增益集，可能會存取您的個人資訊。如果您信任網域以 Office 執行並存取您的資料，請點擊 [確定] 以繼續。";
