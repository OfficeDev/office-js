...
Strings.OfficeOM.L_ConfirmDialogConsentTitle = "Hetki…";
...
Strings.OfficeOM.L_ConfirmDialog = "Toimialue {0} toimii Microsoft Office ja voi suorittaa Office apuosia, jotka voivat käyttää henkilökohtaisia tietojasi. Jos luotat toimialueen suorittamiseen Office ja pystyt käyttämään tietojasi, jatka valitsemalla OK.";
...
Strings.OfficeOM.L_CancelButton = "Peruuta";
...
Strings.OfficeOM.L_ConfirmDialogConsent = "Valitsemalla OK sallit käyttäjälle {0} pääsyn sisältöösi ja henkilökohtaisiin tietoihisi. ";
