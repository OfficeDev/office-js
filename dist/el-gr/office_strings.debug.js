...
Strings.OfficeOM.L_CustomFunctionImplementationMissing = 'Η ιδιότητα με αυτό το όνομα στο Excel.CustomFunctions που αναπαριστά τον ορισμό της συνάρτησης πρέπει να περιέχει μια ιδιότητα "κλήσης" που υλοποιεί τη συνάρτηση.';
...
Strings.OfficeOM.L_CustomFunctionDefinitionMissing = "Στο Excel.CustomFunctions πρέπει να υπάρχει μια ιδιότητα με αυτό το όνομα που αναπαριστά τον ορισμό της συνάρτησης.";
