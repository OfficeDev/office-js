...
Strings.OfficeOM.L_ConfirmDialogConsent = "Κάνοντας κλικ στο OK, θα επιτρέψετε την{0} πρόσβαση στο περιεχόμενό σας και τις προσωπικές πληροφορίες σας. ";
...
Strings.OfficeOM.L_BindingToMultipleSelection = "Οι μη συνεχ��μενες επιλογές δεν υποστηρίζονται.";
...
Strings.OfficeOM.L_CancelButton = "Άκυρο";
...
Strings.OfficeOM.L_ConfirmDialogConsentTitle = "Μια στιγμή...";
...
Strings.OfficeOM.L_ConfirmDialog = "Ο {0} τομέα λειτουργεί ως Microsoft Office και μπορεί να εκτελεί πρόσθετα Office, τα οποία ενδέχεται να έχουν πρόσβαση στα προσωπικά σας δεδομένα. Εάν εμπιστεύεστε τον τομέα ώστε να εκτελείται ως Office και να αποκτάτε πρόσβαση στα δεδομένα σας, κάντε κλικ στο κουμπί OK για να συνεχίσετε.";
...
Strings.OfficeOM.L_OperationNotSupportedOnMatrixData = "Το επιλεγμένο περιεχόμενο πρέπει να είναι σε μορφή πίνακα. Μορφοποι��στε τα δεδομένα ως πίνακα και προσπαθήστε ξανά.";
