        ...
        var RequirementsMatrixFactory = function()
            {
                ...
                RequirementsMatrixFactory.Word_RCLIENT_1601 = "2-16.00";
                ...
                RequirementsMatrixFactory.Word_IOS_16001 = "4096-16.001";
...
OSF.InitializationHelper.prototype.loadAppSpecificScriptAndCreateOM = function OSF_InitializationHelper$loadAppSpecificScriptAndCreateOM(appContext, appReady, basePath)
{
    ...
    OSF.DDA.OutlookAppOm.prototype = {
        ...
        {
            var normalizedToRecipients = OSF.DDA.OutlookAppOm._validateAndNormalizeRecipientEmails$p(parameters["toRecipients"],"toRecipients");
            var normalizedCcRecipients = OSF.DDA.OutlookAppOm._validateAndNormalizeRecipientEmails$p(parameters["ccRecipients"],"ccRecipients");
            var normalizedBccRecipients = OSF.DDA.OutlookAppOm._validateAndNormalizeRecipientEmails$p(parameters["bccRecipients"],"bccRecipients");
            OSF.DDA.OutlookAppOm._validateOptionalStringParameter$p(parameters["body"],0,OSF.DDA.OutlookAppOm.maxBodyLength,"body");
            OSF.DDA.OutlookAppOm._validateOptionalStringParameter$p(parameters["subject"],0,OSF.DDA.OutlookAppOm._maxSubjectLength$p,"subject");
            var attachments = OSF.DDA.OutlookAppOm._getAttachments$p(parameters);
            ...
            if(attachments)
                updatedParameters["attachments"] = OSF.DDA.OutlookAppOm._createAttachmentsDataForHost$p(attachments);
            this._invokeHostMethod$i$0(44,"DisplayNewMessageForm",updatedParameters || parameters,null)
        },
