...
Strings.OfficeOM.L_AppNotExistInitializeNotCalled = "التطبيق {0} غير موجود. لم يتم استدع��ء Microsoft.Office.WebExtension.initialize (السبب).";
...
Strings.OfficeOM.L_ConfirmDialogConsent = 'بالنقر فوق "موافق"، ستسمح لـ {0} بالوصول إلى المحتوى والمعلومات الشخصية. ';
...
Strings.OfficeOM.L_ConfirmDialog = 'تعمل {0} المجال ك Microsoft Office ويمكنها تشغيل وظائف Office الإضافية التي قد يمكنها الوصول إلى بياناتك الشخصية. إذا كنت تثق في المجال الذي سيتم تشغيله ك Office والوصول إلى بياناتك، انقر فوق "موافق" للمتابعة.';
