...
Strings.OfficeOM.L_InvalidBinding = "የማይሰራ አተጣጠፍ";
...
Strings.OfficeOM.L_SelectionCannotBound = "ወደ አሁኑ ስፍራ ሊታጠፍ አይችልም።";
...
Strings.OfficeOM.L_EventHandlerNotExist = "ለዚህ አተጣጠፍ የሚሆን ተለይቶ የተገለፀው የፍፃሜ ያዥ ሊገኝ አልቻለም።";
...
Strings.OfficeOM.L_InvalidBindingError = "የማይሰራ የአተጣጠፍ ስህተት";
Strings.OfficeOM.L_NotSupportedBindingType = "ተለይቶ የተገለፀው አተጣጠፍ ዓይነት {0} የሚደገፍ አይደለም።";
...
Strings.OfficeOM.L_BindingNotExist = "ተለይቶ የተገለፀው አተጣጠፍ የለም።";
...
Strings.OfficeOM.L_OperationNotSupportedOnThisBindingType = "ክንውኑ እዚህኛው የአተጣጠፍ አይነት ላይ የሚደገፍ አይደለም።";
Strings.OfficeOM.L_AppNameNotExist = "የ {0} ተጨማሪ ስም የለም።";
Strings.OfficeOM.L_InvalidBindingOperation = "የማይሰራ የአተጣጠፍ ኦፕሬሽን";
Strings.OfficeOM.L_InvalidFormatValue = "ከቅርጽ ፓራሜትሮች አንዱ ወይም ከዛ በላይ የማይፈቀዱ ዋጋዎች ይዘዋል። ዋጋዎቹን እንደገና ይፈትሹዋቸው እና እንደገና ይሞክሩ።";
Strings.OfficeOM.L_DataNotMatchBindingType = "ተለይቶ ተገለፀው የውሂብ ነገር ከአተጣጠፍ ዓይነቱ ጋር የሚጣጣም አይደለም።";
...
Strings.OfficeOM.L_InvalidSelectionForBindingType = "በአሁኑ ምርጫ እና በዚህኛው የማጠፊያ አይነት ማጠፍ ልፈጠር አይችልም።";
...
Strings.OfficeOM.L_CoercionTypeNotMatchBinding = "ተለይቶ የተገለፀው አስገዳጅ ዓይነት ከአተጣጠፍ ዓይነቱ ጋር የሚጣጣም አይደለም።";
...
Strings.OfficeOM.L_UnknownBindingType = "የአተጣጠፍ አይነቱ የሚደገፍ አይደለም።";
...
Strings.OfficeOM.L_InvalidNamedItemForBindingType = "ተለይቶ የተገለፀው አተጣጠፍ ዓይነት ከቀረበው ስሙ ከተጠቀሰው ነገር ጋር የሚጣጣም አይደለም።";
...
Strings.OfficeOM.L_BindingCreationError = "ማጠፊያ የመፍጠር ስህተት";
