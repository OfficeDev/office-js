...
Strings.OfficeOM.L_ConfirmDialogConsent = "OK түймешігін басу арқылы {0} доменіне мазмұнға және жеке ақпаратқа қатынасуға рұқсат бересіз. ";
...
Strings.OfficeOM.L_OperationNotSupportedOnMatrixData = "Таңд��лған мазмұн кесте пішімінде болуы керек. Деректерді кесте ретінде пішіндеп, әрекетті қайталаңыз.";
...
Strings.OfficeOM.L_ConfirmDialogConsentTitle = "Бір мезет";
...
Strings.OfficeOM.L_CancelButton = "Бас тарту";
