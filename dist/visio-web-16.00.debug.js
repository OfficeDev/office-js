...
// runtime: 16.0.12306.30003
// core: 16.0\12311.10000
// host: 16.0\16.0.12311.34952
...
(function (OfficeCore) {
	...
	var _typeAppRuntimeEvent="AppRuntimeEvent";
	var AppRuntimeEvent=(function (_super) {
		__extends(AppRuntimeEvent, _super);
		function AppRuntimeEvent() {
			return _super !==null && _super.apply(this, arguments) || this;
		}
		Object.defineProperty(AppRuntimeEvent.prototype, "_className", {
			get: function () {
				return "AppRuntimeEvent";
			},
			enumerable: true,
			configurable: true
		});
		AppRuntimeEvent.prototype._RegisterVisibilityChangedEvent=function () {
			_invokeMethod(this, "_RegisterVisibilityChangedEvent", 0, [], 0, 0);
		};
		AppRuntimeEvent.prototype._UnregisterVisibilityChangedEvent=function () {
			_invokeMethod(this, "_UnregisterVisibilityChangedEvent", 0, [], 0, 0);
		};
		AppRuntimeEvent.prototype._handleResult=function (value) {
			_super.prototype._handleResult.call(this, value);
			if (_isNullOrUndefined(value))
				return;
			var obj=value;
		...
		AppRuntimeEvent.prototype._handleRetrieveResult=function (value, result) {
			_super.prototype._handleRetrieveResult.call(this, value, result);
			_processRetrieveResult(this, value, result);
		};
		AppRuntimeEvent.newObject=function (context) {
			return _createTopLevelServiceObject(OfficeCore.AppRuntimeEvent, context, "Microsoft.AppRuntime.AppRuntimeEvent", false, 4);
		};
		Object.defineProperty(AppRuntimeEvent.prototype, "onVisibilityChanged", {
			get: function () {
				var _this=this;
				if (!this.m_visibilityChanged) {
					this.m_visibilityChanged=new OfficeExtension.GenericEventHandlers(this.context, this, "VisibilityChanged", {
						eventType: 65539,
						registerFunc: function () { return _this._RegisterVisibilityChangedEvent(); },
						unregisterFunc: function () { return _this._UnregisterVisibilityChangedEvent(); },
						getTargetIdFunc: function () { return ""; },
						eventArgsTransformFunc: function (value) {
							var eventArgs={
								visibility: value.message
							};
							return OfficeExtension.Utility._createPromiseFromResult(eventArgs);
						}
					});
				}
		...
		AppRuntimeEvent.prototype.toJSON=function () {
			return _toJson(this, {}, {});
		};
		return AppRuntimeEvent;
	}(OfficeExtension.ClientObject));
	OfficeCore.AppRuntimeEvent=AppRuntimeEvent;
...
(function (OfficeRuntime) {
	...
	var VisibilityChanged=(function () {
		...
		VisibilityChanged.prototype.add=function (callback) {
			var appRtManager=AppRuntimeManager.getInstance();
			var evt=appRtManager.getEvent();
			var handler=evt.onVisibilityChanged.add(callback);
			return appRtManager.context.sync().then(function () {
				return OfficeExtension.Utility._createPromiseFromResult(handler);
			});
		};
		;
		VisibilityChanged.prototype.remove=function (callback) {
			var appRtManager=AppRuntimeManager.getInstance();
			if (typeof callback==="function") {
				var evt=appRtManager.getEvent();
				evt.onVisibilityChanged.remove(callback);
			}
			else {
				callback.remove();
			}
	...
	OfficeRuntime.VisibilityChanged=VisibilityChanged;
	;
	OfficeRuntime.onVisibilityChanged=new VisibilityChanged();
	...
	var AppRuntimeManager=(function () {
		...
		AppRuntimeManager.prototype.getEvent=function () {
			if (!this._appRuntimeEvent) {
				this._appRuntimeEvent=OfficeCore.AppRuntimeEvent.newObject(AppRuntimeManager.getInstance().context);
			}
			return this._appRuntimeEvent;
		};
		return AppRuntimeManager;
	}());
	OfficeRuntime.context=AppRuntimeManager.getInstance().context;
